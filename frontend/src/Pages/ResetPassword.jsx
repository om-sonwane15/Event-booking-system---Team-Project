...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center p-4"style={{ backgroundImage: "url('/pic1.avif')" }}>
      <div className="bg-white bg-opacity-80 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden w-full max-w-5xl flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 p-8 sm:p-10">
         ...
         <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit"disabled={isLoading || !tokenValid}
          className={`mx-auto block w-40 py-3 rounded-full text-white cursor-pointer font-semibold transition-all duration-200 ${
            isLoading || !tokenValid ? "bg-gray-400 cursor-not-allowed" : "bg-cyan-600 hover:bg-cyan-700 active:bg-cyan-800"}`}>
