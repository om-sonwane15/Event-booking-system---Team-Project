...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center px-4 sm:px-6"
      ...
      <div className="bg-white bg-opacity-90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col lg:flex-row overflow-hidden">
        <div className="mt-6 lg:mt-12 w-full lg:w-1/2 p-6 sm:p-8 md:p-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 text-center">Forgot Password</h2>
          <p className="text-center text-sm text-gray-500 mb-6">
            Enter your email to receive a reset link</p>
          <form onSubmit={handleForgot} className="mt-4 space-y-5">
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"><FiMail />
              </div>
